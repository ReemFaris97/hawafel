         ...
         <div class="col-md-9 clo-xs-12">
            <div class=" all-sections">
               ...
               <div class="row grid grid1">
                  <div class="col-sm-4 col-xs-12 wow animate__ animate__backInUp animated notmrgrsp divcontentitem">
                     <div class=" item">
                        ...
                        <div class="gallery_item_info editbook">
                            <div class="hottelname">فندق كمبينسكي العثمان</div>
                            <div class="flexstar">
                            ...
                            <div class="relativeZ flexlinkoffer">
                                <a href="{{url('booking-details')}}" class="btn-hvr editwidthbtn"> حجز</a>
                                <div class="deletall"><i class="fas fa-trash"></i></div>
                            </div>
                        </div>
                     </div>
                  </div>
...
$(".deletall").click(function() {
    $(this).parents(".divcontentitem").fadeOut( "slow").remove()
});
</script>
@endsection
